    ...
    class Html
      ...
      def embed_image(src, label)
        ...
        @builder.span(:class => 'embed') do |pre|
		  ...
		  if (src.include? "#{src.split('_')[0]}_screenshot_") && (!@previous_control_image.nil?)
            ...
            screenshot_pc = src.split('/')[src.split('/').length-1].split('_')
			img_name = nil
			screenshot_pc.each do |pc|
				img_name = "#{img_name}_#{pc}" if !pc.include? '.png'
			end
			img_name = img_name[1..img_name.length]
			
            control_image_path = "#{File.absolute_path(src)[0..File.absolute_path(src).index('/screenshots')]}control_images"
            control_image_name = "#{control_image_path}/#{img_name}"
            control_image = "#{control_image_name}.png"
		...
		pre << %{<table width="100%" align="center" border="0">
          <tr><td align="right" width="50%">Base Image</td><td align="left" width="50%">Screenshot</td></tr>
          ...
          <tr><td align="right" width="50%"><img id="#{control_id}" style="display: none" src="data:image/png;base64,#{encrypted_control_image}"/></td>
            <td align="left" width="50%"><img id="#{id}" style="display: none" src="data:image/png;base64,#{encrypted_image}"/></td></tr>
          }
        end
      end
